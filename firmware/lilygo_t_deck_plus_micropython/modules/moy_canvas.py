...
class Blitter:
    ...
    def __init__(self, bus, canvas_x, canvas_y, canvas_size):
        ...
        # Allocated via moy_alloc, not lcd_bus.allocate_framebuffer, because the
        # latter is capped at 2 slots (both taken by the LVGL draw buffers).
        self._dma = moy_alloc.malloc_dma(canvas_size * canvas_size * 2)
        self._source = None
...
def make_blitter(bus, canvas_x, canvas_y, canvas_size):
    ...
    try:
        ...
        print("Moybyte moy_canvas disabled:", exc)
        return None

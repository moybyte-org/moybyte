...
# kid_runtime). The others are bring-up/validation modes -- flip one True, read the
# serial output, flip it back. (The old LVGL 128x128 `.kcproj` game loop that used
...
RUN_COMPOSITOR_SMOKE = False    # dirty-rect compositor + kc_gfx smoke (docs/history/STAGE3_PLAN.md)

...
# (map.kmap): the brick/steel field is ONE native map() blit, and destroying a brick
...
MW = 15              # tilemap width in cells  (matches map.kmap)
...
def _init():
    ...
    # rebuild the brick/steel field from the cart's tilemap source (map.kmap),
...
# original layout from map.kmap ONCE and stamp it back at each round start.
_FIELD0 = None

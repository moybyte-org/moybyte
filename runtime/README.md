...
| `kid_carts.py` | **(shared, staged to device)** the `.kcart` store — scan/load/save_config/save_code/save_sprites/save_sounds/create/duplicate/delete (dict carts; only `json`+`os`) |

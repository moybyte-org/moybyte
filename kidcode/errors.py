...
class KidCodeError(Exception):
    """Base KidCode exception."""


class ManifestError(KidCodeError):
    """Raised when a project manifest is invalid."""


class PermissionDenied(KidCodeError):
...
class KidCodeRuntimeError(KidCodeError):

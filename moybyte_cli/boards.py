"""Known hardware board profiles for Moybyte tooling."""
...
def export_device_project(project_path, board_id, out_dir):
    ...
    deploy = {
        "schema": "moybyte.device_export.v1",
        "board": profile["id"],
        "platformio_env": profile["platformio_env"],
    ...
    with open(readme_path, "w", encoding="utf-8") as fh:
        fh.write("# Moybyte Device Export\n\n")
        fh.write("Board: " + profile["title"] + "\n\n")
        fh.write("Bundle: `" + bundle_name + "`\n\n")
        fh.write("Use this directory as the firmware-side input for the Moybyte runner.\n")
    return out_dir

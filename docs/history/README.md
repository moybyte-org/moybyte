...
[`moybyte_Console_Plan_v0_4.md`](../../moybyte_Console_Plan_v0_4.md) at the repo
...
| doc | status |
|---|---|
| `moybyte_Console_Plan_v0_4.md` (repo root) | **current** — the v0.4 "fantasy workstation / everything is a cartridge" direction |

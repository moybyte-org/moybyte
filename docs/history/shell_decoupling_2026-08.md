...
[`docs/history/ui_refactor_2026-08.md`](ui_refactor_2026-08.md); read its §1
before re-proposing anything below, because rows 7-8, 9, 10 and 11 were all
declined there with reasons. What survives here is the material that plan
cites rather than repeats: the `ws` inventory, the per-row measurements, the
numbers.
